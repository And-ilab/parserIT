...
BLACKLIST = [
    ...
    # Пищевка / молоко / упаковка; ЧПУ и промышленные станки (ловятся на «програм»/«автоматиз»)
    'пастеризацион',
    'пастеризационно-охладительн',
    'пластинчатой автоматизированной пастеризационно',
    'охладительн установк',
    'сыродельн',
    ' uht ',
    'uht установк',
    'приёмки и учета молока',
    'электронные компоненты',
    'газотурбинн',
    'газотурбинной установ',
    'главной инспекции газотурбин',
    'закупка оборудования производства авв',
    'закупка оборудования производства abb',
    'реле abb',
    'реле siemens',
    'реле shneider',
    'реле schneider',
    ...
    'копировально-прошивного станка',
    'гибочного автоматизированного станка',
    'панелегиб',
    'вертикального станка с чпу',
    'станка с чпу',
    'электроэрозионного',
    'закалочн установк',
