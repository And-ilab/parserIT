...
KEYWORDS_ROOTS = [
    ...
    # ПО, ИС, инфраструктура
    'программн обеспеч', 'программн продукт', 'программн комплекс',
    'прикладн программ', 'системн программ', 'web-прилож', 'мобильн прилож',
    'информационн систем', 'информационн технолог', 'информационн ресурс',
    'автоматизаци бизнес', 'автоматизаци процесс',
    'автоматизированн систем управлен', 'асу ', 'асутп',
    ...
    'разработк программ', 'разработк по', 'сопровождени программ',
    'доработк программ', 'доработк конфигурац', 'внедрени erp', 'внедрени crm',
    'внедрени информационн', 'лицензи на программ', 'лицензи по',
