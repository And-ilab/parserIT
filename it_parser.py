...
KEYWORDS_ROOTS = [
    'программ', 'разработк', 'доработк', 'модернизац', 'внедрени',
    'информационн', 'автоматизац', 'систем', 'erp', 'crm',
    'искусственн', 'интеллектуал', 'нейросет', 'машинн', 'анализ', 'big data',
    'распознаван', 'прогнозир', 'рекомендательн', 'llm', 'gpt', 'ai',
    'лиценз', 'сопровожд', 'обновлен',
    'сервер', 'cloud', 'виртуализац', 'cisco', 'oracle',
    'планшет', 'ноутбук', 'серверн', 'программно-аппаратн',
    'баз данных', 'база данн',
]
...
BLACKLIST = [
    ...
    'ремонт', 'кровля', 'фасад',
    # новые (для фильтрации мусора)
    'павильон', 'сэндвич-панел', 'едкий натр', 'электротехническ',
...
# ---------- СЕМАНТИЧЕСКОЕ ЯДРО ДЛЯ ИТ ----------
KEYWORDS_ROOTS = [
    'искусственн', 'интеллектуал', 'ai', 'нейросет', 'машинн', 'глубок',
    'нейронн', 'dnn', 'ml', 'dl', 'анализ', 'когнитивн',
    'распознаван', 'кластеризац', 'сегментац', 'экспертн', 'прогнозир',
    'рекомендательн', 'big data', 'аналитик',
    'компьютерн', 'зрени', 'обработк изображени', 'ocr', 'nlp', 'llm',
    'bert', 'gpt', 'трансформер', 'семантическ',
    'программн', 'development', 'разработк', 'доработк', 'модернизаци',
    'внедрени', 'автоматизаци', 'информационн', 'информац систем',
    'erp', 'crm', 'управлени',
    'лицензи', 'продлени', 'обновлени', 'техническ', 'сервисн', 'абонентск',
    'аппаратн', 'средств', 'сервер', 'сете', 'виртуализаци', 'cloud',
]
...
if __name__ == '__main__':
    main()
    log_handle.close()
>>>>>>> 77119708a3bf28b78008afb77aeddf4ff847428a
